package org.geektimes.oauth.service;

import org.geektimes.oauth.converter.MyOAuth2UserRequestEntityConverter;
...
/**
 * 内置DefaultOAuth2UserService 无法自定义converter，只好替换service
 */
@Service
public class MyOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    private Converter<OAuth2UserRequest, RequestEntity<?>> requestEntityConverter = new MyOAuth2UserRequestEntityConverter();
